<template>
  <div class="floating-buttons">
    ...
    <a
      href="https://www.instagram.com/yuscottage"
      target="_blank"
      rel="noopener"
      class="floating-button"
...
.floating-button {
  ...
  border: 1px solid rgba(230, 192, 133, 0.22);
  display: flex;
...
.floating-button:hover {
  ...
  border-color: rgba(230, 192, 133, 0.42);
  transform: translateY(-2px);
  box-shadow:
    inset 0 1px 0 rgba(255, 255, 255, 0.08),
    0 10px 28px rgba(0, 0, 0, 0.2),
    0 0 18px rgba(230, 192, 133, 0.08);
}

.floating-button:focus-visible {
  outline: 1px solid rgba(230, 192, 133, 0.75);
  outline-offset: 4px;
}
